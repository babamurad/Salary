...
// Обязательный (по единой ставке из настроек) и добровольный (meyletin,
// индивидуальный % по сотруднику) пенсионные взносы за выбранный месяц —
// отдельный реестр для сдачи в Пенсионный фонд.
...
// Реестр сумм к перечислению на карты сотрудников за выбранный месяц
// (зарплата на карту, не наличными) — для передачи в обслуживающий банк.
