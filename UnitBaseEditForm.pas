...
// Процедура для загрузки списков из базы в ComboBox
...
begin
  LoadLists; // Каждый раз при открытии окна списки будут свежими
end;
...
var
  i, TargetID: Integer;
begin
  // 1. СНАЧАЛА принудительно загружаем списки из базы в ComboBox
  LoadLists;
...
begin
  // Заполняем Отделы
  frmBaseEdit.cmbDept.Items.Clear;
