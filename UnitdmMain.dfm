    ...
    SQLScripts = <
      item
        SQL.Strings = (
          ...
          #9'"id"'#9'INTEGER,'
          #9'"payroll_id"'#9'INTEGER NOT NULL,'
          #9'"item_type"'#9'TEXT NOT NULL,'
          #9'"item_name"'#9'TEXT NOT NULL,'
          #9'"details"'#9'TEXT,'
          #9'"base_amount"'#9'CURRENCY,'
          #9'"rate_percent"'#9'REAL,'
          #9'"amount"'#9'CURRENCY NOT NULL,'
          #9'"sort_order"'#9'INTEGER NOT NULL DEFAULT 0,'
          #9'PRIMARY KEY("id" AUTOINCREMENT),'
          #9'FOREIGN KEY("payroll_id") REFERENCES "payroll_journal"("id") ON DELETE CASCADE'
          ');'
          'CREATE TABLE IF NOT EXISTS "payroll_calc_inputs" ('
          #9'"payroll_id"'#9'INTEGER,'
          #9'"work_days"'#9'REAL,'
          #9'"work_hours"'#9'REAL,'
          #9'"norm_days"'#9'INTEGER,'
          #9'"norm_hours"'#9'REAL,'
          #9'"wage_type"'#9'INTEGER,'
          #9'"work_fraction"'#9'REAL,'
          #9'"hourly_rate_db"'#9'REAL,'
          #9'"base_salary"'#9'CURRENCY,'
          #9'"is_rotation"'#9'INTEGER,'
          #9'"rotation_rate"'#9'REAL,'
          #9'"class_rank"'#9'INTEGER,'
          #9'"class_rate"'#9'REAL,'
          #9'"pension_rate"'#9'REAL,'
          #9'"is_trade_union"'#9'INTEGER,'
          #9'"union_rate"'#9'REAL,'
          #9'"is_tax_exempt"'#9'INTEGER,'
          #9'"tax_rate"'#9'REAL,'
          #9'"dep_count"'#9'INTEGER,'
          #9'"dep_deduction"'#9'REAL,'
          #9'"alimony_pct"'#9'REAL,'
          #9'PRIMARY KEY("payroll_id"),'
          #9'FOREIGN KEY("payroll_id") REFERENCES "payroll_journal"("id") ON DELETE CASCADE'
          ');'
